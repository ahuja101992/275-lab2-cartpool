...
class Profile extends Component {
    constructor(props) {
        ...
        this.state = Object.assign({}, { firstName: this.props.firstName }, { lastName: this.props.lastName }, { email: this.props.email }, { imageUrl: this.props.imageUrl },
            { street: this.props.street }, { city: this.props.city }, { state: this.props.state }, { zip: this.props.zip }, { screenName: this.props.screenName }, { nickName: this.props.nickName },
            { credits: this.props.credits }, { setShow: false }, { tempNickName: this.props.nickName }, { tempFirstName: this.props.firstName }, { tempLastName: this.props.lastName }, { tempEmail: this.props.email },
    ...
    render() {
        console.log(this.props.tempNickName)
        return (
            <React.Fragment>
                ...
                <form className="form-horizontal">
                    <fieldset className="fieldset">
                        ...
                        <div className="form-group">
                            <label className="col-md-2 col-sm-3 col-xs-12 control-label">Nick
                                Name</label>
                            <div className="col-md-10 col-sm-9 col-xs-12">
                                <input type="text" className="form-control"
                                    value={this.state.nickName} onChange={this.changeHandeler} />
                            </div>
                        </div>
                    ...
                    <Modal.Body>
                        ...
                        <Form>
                            ...
                            <Form.Group controlId="formGroupItemName">
                                ...
                                <Form.Control type="text" name="tempNickName"
                                    value={this.state.tempNickName} className="join-pool-modal-text"
